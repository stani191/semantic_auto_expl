...
int testOpenDoorRecognitionOnDB_Debug_Yes(std::string path, OpenDoorRecognitionApp o){
    ROS_INFO("Starting door recognition on sim database - DEBUG");
    o.setDebugFlag();
...
int testOpenDoorRecognitionOnDB_Sim_Yes(std::string path, OpenDoorRecognitionApp o){
    ROS_INFO("Starting door recognition on sim database - positives");
...
int testOpenDoorRecognitionOnDB_Sim_No(std::string path, OpenDoorRecognitionApp o){
    ROS_INFO("Starting door recognition on sim database - negatives");
    sensor_msgs::PointCloud2 input_cloud;
    PointCloud<PointXYZ>::Ptr cloud (new PointCloud<PointXYZ>);
...
int testOpenDoorRecognitionOnDB_Sim_RansacEpsAngle(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
    ...
    for (double angle : ransacEpsAngles){
        ...
        testOpenDoorRecognitionOnDB_Sim_Yes(doorspath_sim_yes, o);
        testOpenDoorRecognitionOnDB_Sim_No(doorspath_sim_no, o);
...
int testOpenDoorRecognitionOnDB_Sim_RansacDistanceThreshold(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_RansacMaxIterations(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_Alpha(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_StripeNoise(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_CubeDistance(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_MaxNoise(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
...
int testOpenDoorRecognitionOnDB_Sim_All(std::string doorspath_sim_yes,std::string doorspath_sim_no, OpenDoorRecognitionApp o){
    testOpenDoorRecognitionOnDB_Sim_RansacEpsAngle(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_RansacDistanceThreshold(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_RansacMaxIterations(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_Alpha(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_StripeNoise(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_CubeDistance(doorspath_sim_yes, doorspath_sim_no, o);
    testOpenDoorRecognitionOnDB_Sim_MaxNoise(doorspath_sim_yes, doorspath_sim_no, o);
}

int main(int argc, char **argv){

    ros::init(argc, argv, "experiments_open_door_sim");
    std::string doorspath_sim_yes = "//home//stanic//master_thesis//catkin_workspace//src//semantic_auto_expl//semantic_mapping//pcd//doors_sim//open_doors//";
    std::string doorspath_sim_no = "//home//stanic//master_thesis//catkin_workspace//src//semantic_auto_expl//semantic_mapping//pcd//doors_sim//no_open_doors//";
    //std::string stairspath = ;
    OpenDoorRecognitionApp o;
    if (argc > 1 && argv[1] == "debug"){
        ros::console::set_logger_level(ROSCONSOLE_DEFAULT_NAME, ros::console::levels::Debug);
        testOpenDoorRecognitionOnDB_Debug_Yes(doorspath_sim_yes, o);
    } else {
        ros::console::set_logger_level(ROSCONSOLE_DEFAULT_NAME, ros::console::levels::Warn);
        testOpenDoorRecognitionOnDB_Sim_All(doorspath_sim_yes, doorspath_sim_no, o);
    }
    //testOpenDoorRecognitionOnDB_Sim_Yes(doorspath_sim_yes, o);
    //testOpenDoorRecognitionOnDB_Sim_No(doorspath_sim_no, o);
